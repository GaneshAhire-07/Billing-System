...
const GenerateBill = ({ isGST }) => {
  ...
  return (
    <div className="p-8 max-w-[75vw] w-full mx-auto my-8" style={{ minHeight: '60vh' }}>
      ...
      <div className="space-y-6">
        ...
        {total && <p className="mt-4 text-xl font-semibold text-gray-800">{total}</p>}
      </div>
            ...
            <div className="border border-gray-300 p-4 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <div className="text-lg">
                  <div className="font-semibold">Cirasthayi Technology PVT. LTD.</div>
